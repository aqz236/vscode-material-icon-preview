import { createFileRoute, lazyRouteComponent, createRootRoute, HeadContent, Scripts, RouterProvider, createRouter as createRouter$1 } from '@tanstack/react-router';
  ...
  return createServerFnStaticCache({
    getItem: async (ctx) => {
      if (typeof document === "undefined") {
        ...
        const publicUrl = "/Users/ttx/Projects/TurboRepo/material-icon-preview-web/apps/web/.output/public";
        const {
          promises: fs2
...
async function loadVirtualModule(id) {
  switch (id) {
    ...
    case VIRTUAL_MODULES.startManifest:
      return await import('./_tanstack-start-manifest_v-CfaAloB_.mjs');
    case VIRTUAL_MODULES.serverFnManifest:
      return await import('./_tanstack-start-server-fn-manifest_v-BKdEhagL.mjs');
    default:
...
const appCss = "/assets/styles-Cfz3f-vR.css";
...
const $$splitComponentImporter$3 = () => import('./index-B057XqEw.mjs');
const Route$3 = createFileRoute("/")({
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import('./demo.mcp-todos-Bof5d6x1.mjs');
const Route$2 = createFileRoute("/demo/mcp-todos")({
...
const $$splitComponentImporter$1 = () => import('./demo.start.server-funcs-Bk7fAKuK.mjs');
...
const $$splitComponentImporter = () => import('./demo.start.api-request-DKcfJf2Q.mjs');
...
const DemoMcpTodosRoute = Route$2.update({
  id: "/demo/mcp-todos",
  path: "/demo/mcp-todos",
  getParentRoute: () => Route$4
});
...
const McpServerRoute = ServerRoute$2.update({
  id: "/mcp",
  path: "/mcp",
  getParentRoute: () => rootServerRouteImport
});
const ApiMcpTodosServerRoute = ServerRoute$1.update({
  id: "/api/mcp-todos",
  path: "/api/mcp-todos",
  getParentRoute: () => rootServerRouteImport
});
