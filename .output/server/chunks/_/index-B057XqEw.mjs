...
var IconPack = /* @__PURE__ */ ((IconPack2) => {
  ...
  IconPack2["Roblox"] = "roblox";
  IconPack2["Qwik"] = "qwik";
  IconPack2["Vue"] = "vue";
  IconPack2["Vuex"] = "vue_vuex";
  return IconPack2;
})(IconPack || {});
var FileNamePattern = /* @__PURE__ */ ((FileNamePattern2) => {
  FileNamePattern2["Ecmascript"] = "ecmascript";
  FileNamePattern2["Configuration"] = "configuration";
  FileNamePattern2["NodeEcosystem"] = "nodeEcosystem";
  FileNamePattern2["Cosmiconfig"] = "cosmiconfig";
  FileNamePattern2["Yaml"] = "yaml";
  FileNamePattern2["Dotfile"] = "dotfile";
  return FileNamePattern2;
})(FileNamePattern || {});
...
function getFileIcons() {
  ...
  fileIcons.icons.forEach((icon) => {
    ...
    icons.push({
      ...
      description: `File icon for ${((_a = icon.fileExtensions) == null ? void 0 : _a.join(", ")) || ((_b = icon.fileNames) == null ? void 0 : _b.join(", ")) || icon.name}`
    });
  });
  icons.push({
...
function getFolderIcons() {
  ...
  folderIcons.forEach((theme) => {
    ...
    (_a = theme.icons) == null ? void 0 : _a.forEach((icon) => {
      var _a2;
      icons.push({
        name: icon.name,
        category: "folder",
        folderNames: icon.folderNames,
        description: `Folder icon for ${((_a2 = icon.folderNames) == null ? void 0 : _a2.join(", ")) || icon.name}`
      });
    });
  });
  return icons;
...
function searchIcons(query) {
  ...
  return allIcons.filter(
    (icon) => {
      var _a, _b, _c, _d;
      return icon.name.toLowerCase().includes(searchTerm) || ((_a = icon.description) == null ? void 0 : _a.toLowerCase().includes(searchTerm)) || ((_b = icon.extensions) == null ? void 0 : _b.some((ext) => ext.toLowerCase().includes(searchTerm))) || ((_c = icon.fileNames) == null ? void 0 : _c.some((name) => name.toLowerCase().includes(searchTerm))) || ((_d = icon.folderNames) == null ? void 0 : _d.some((name) => name.toLowerCase().includes(searchTerm)));
    }
  );
}
...
function IconCard({
  ...
  const getAssociations = () => {
    ...
    if (fileNames == null ? void 0 : fileNames.length) {
      associations.push(`Files: ${fileNames.join(", ")}`);
    }
    if (folderNames == null ? void 0 : folderNames.length) {
  ...
  return /* @__PURE__ */ jsx("div", { className: "bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4 hover:shadow-lg transition-shadow duration-200", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center space-y-3", children: [
    /* @__PURE__ */ jsxs("div", { className: "relative w-16 h-16 flex items-center justify-center bg-gray-50 dark:bg-gray-700 rounded-lg", children: [
      ...
      ) : /* @__PURE__ */ jsx("div", { className: "w-12 h-12 bg-gray-300 dark:bg-gray-600 rounded flex items-center justify-center text-xs text-gray-500", children: "\u7F3A\u5931" }),
      /* @__PURE__ */ jsx("div", { className: "absolute -top-1 -right-1 bg-blue-500 text-white text-xs px-1.5 py-0.5 rounded-full", children: category === "file" ? "F" : "D" })
    ] }),
    ...
    hasLightVariant && /* @__PURE__ */ jsx(
      "button",
      {
        ...
        children: lightMode ? "\u6D45\u8272" : "\u6DF1\u8272"
      }
    ),
    description && /* @__PURE__ */ jsx("p", { className: "text-xs text-gray-600 dark:text-gray-400 text-center line-clamp-2", children: description }),
    getAssociations().length > 0 && /* @__PURE__ */ jsx("div", { className: "w-full", children: /* @__PURE__ */ jsxs("details", { className: "text-xs", children: [
      /* @__PURE__ */ jsx("summary", { className: "cursor-pointer text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200", children: "\u5173\u8054\u4FE1\u606F" }),
      /* @__PURE__ */ jsx("div", { className: "mt-2 space-y-1", children: getAssociations().map((association, index) => /* @__PURE__ */ jsx("div", { className: "text-gray-600 dark:text-gray-400 bg-gray-50 dark:bg-gray-700 p-2 rounded", children: association }, index)) })
    ] }) })
  ] }) });
}
function IconGrid() {
    ...
    if (selectedCategory !== "all") {
      ...
      if (searchQuery.trim()) {
        icons = icons.filter(
          (icon) => {
            var _a;
            return icon.name.toLowerCase().includes(searchQuery.toLowerCase()) || ((_a = icon.description) == null ? void 0 : _a.toLowerCase().includes(searchQuery.toLowerCase()));
          }
        );
      }
    }
    const uniqueIcons = icons.filter(
      (icon, index, self) => index === self.findIndex((i) => i.name === icon.name)
    );
    return uniqueIcons;
  ...
  return /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4 py-8", children: [
    /* @__PURE__ */ jsxs("div", { className: "text-center mb-8", children: [
      /* @__PURE__ */ jsx("h1", { className: "text-4xl font-bold text-gray-900 dark:text-white mb-2", children: "Material Icon \u56FE\u6807\u9884\u89C8" }),
      /* @__PURE__ */ jsx("p", { className: "text-gray-600 dark:text-gray-400", children: "VSCode Material Icon Theme \u7684\u6240\u6709\u56FE\u6807\u9884\u89C8\u548C\u641C\u7D22" })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6 mb-8", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col md:flex-row gap-4", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex-1", children: [
          /* @__PURE__ */ jsx("label", { htmlFor: "search", className: "block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2", children: "\u641C\u7D22\u56FE\u6807" }),
          /* @__PURE__ */ jsx(
            "input",
            {
              id: "search",
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("label", { htmlFor: "category", className: "block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2", children: "\u7C7B\u522B\u7B5B\u9009" }),
          /* @__PURE__ */ jsxs(
            "select",
            {
              id: "category",
              ...
              children: [
                ...
                /* @__PURE__ */ jsxs("option", { value: "file", children: [
                  "\u6587\u4EF6\u56FE\u6807 (",
                  getIconsByCategory("file").length,
                  ")"
                ] }),
                /* @__PURE__ */ jsxs("option", { value: "folder", children: [
                  "\u6587\u4EF6\u5939\u56FE\u6807 (",
                  getIconsByCategory("folder").length,
                  ")"
                ] })
              ]
            }
      ...
      /* @__PURE__ */ jsx("div", { className: "mt-4 pt-4 border-t border-gray-200 dark:border-gray-600", children: /* @__PURE__ */ jsxs("p", { className: "text-sm text-gray-600 dark:text-gray-400", children: [
        "\u627E\u5230 ",
        /* @__PURE__ */ jsx("span", { className: "font-semibold text-blue-600 dark:text-blue-400", children: filteredIcons.length }),
        " \u4E2A\u56FE\u6807",
        searchQuery && /* @__PURE__ */ jsxs("span", { children: [
          '\uFF0C\u641C\u7D22: "',
    ...
    currentIcons.length > 0 ? /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 2xl:grid-cols-8 gap-4 mb-8", children: currentIcons.map((icon) => /* @__PURE__ */ jsx(
      IconCard,
      {
        name: icon.name,
      ...
      /* @__PURE__ */ jsx("div", { className: "text-gray-400 mb-4", children: /* @__PURE__ */ jsx("svg", { className: "mx-auto h-12 w-12", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", children: /* @__PURE__ */ jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M9.172 16.172a4 4 0 015.656 0M9 12h6m-6-4h6m2 5.291A7.962 7.962 0 0112 15c-2.34 0-4.47-.881-6.08-2.33" }) }) }),
      /* @__PURE__ */ jsx("h3", { className: "text-lg font-medium text-gray-900 dark:text-white mb-2", children: "\u672A\u627E\u5230\u56FE\u6807" }),
      /* @__PURE__ */ jsx("p", { className: "text-gray-600 dark:text-gray-400", children: "\u5C1D\u8BD5\u8C03\u6574\u641C\u7D22\u6761\u4EF6\u6216\u9009\u62E9\u4E0D\u540C\u7684\u7C7B\u522B" })
    ] }),
    totalPages > 1 && /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-center space-x-2", children: [
      /* @__PURE__ */ jsx(
        "button",
        {
      ...
      getPaginationRange().map((page) => /* @__PURE__ */ jsx(
        "button",
        {
          onClick: () => handlePageChange(page),
          className: `px-3 py-2 text-sm font-medium border ${page === currentPage ? "text-blue-600 bg-blue-50 border-blue-300 dark:bg-blue-900 dark:text-blue-200" : "text-gray-500 bg-white border-gray-300 hover:bg-gray-50 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-600 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white"}`,
          children: page
        },
        page
      )),
...
const SplitComponent = function App() {
  return /* @__PURE__ */ jsx("div", { className: "min-h-screen bg-gray-50 dark:bg-gray-900", children: /* @__PURE__ */ jsx(IconGrid, {}) });
};

export { SplitComponent as component };
//# sourceMappingURL=index-B057XqEw.mjs.map
